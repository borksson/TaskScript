...
import { MarkdownResponseUpdateTasks } from "../markdown/MarkdownResponseUpdateTasks";
...
export class SchoolMarkdownResponseUpdateTasks extends MarkdownResponseUpdateTasks<SchoolTask> {
